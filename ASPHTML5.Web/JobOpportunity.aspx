<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobOpportunity.aspx.cs" Inherits="ASPHTML5.Web.JobOpportunity" MasterPageFile="~/Common.Master" Title="Sodeco Gestion | JobOpportunity" culture="auto" meta:resourcekey="PageResource1" uiculture="auto"%>
...
<%@ Register src="~/UserControls/UCJobListing.ascx" tagname="UC_JobListing" tagprefix="uc1" %>
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="cpHead">
<script>id = ""</script>
<script>id2 = "job_openings"</script>
<div class="font14px"><div style="text-transform: uppercase;"><asp:Literal ID="Literal4" runat="server" Text="<%$Resources:Text.JobOpportunity%>" /></div></div>
</asp:Content>
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="cpMain">
<uc1:UC_JobListing ID="UC_JobListing1" runat="server" />
      <div>
