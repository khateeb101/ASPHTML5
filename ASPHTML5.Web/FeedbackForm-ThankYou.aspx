<%@ Page Title="" Language="C#" MasterPageFile="~/Common.Master" AutoEventWireup="true" CodeBehind="FeedbackForm-ThankYou.aspx.cs" Inherits="ASPHTML5.Web.FeedbackForm_ThankYou" %>
...
<div class="font14px"><div style="text-transform: uppercase;"><asp:Literal ID="litFormTitle" Text="<%$Resources:Text.HeaderTitle%>" runat="server"  /></div>
 </div>
 <script>
