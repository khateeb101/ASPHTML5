<%@ Page Title="Sodeco Gestion | Thank You For Contact Us" Language="C#" MasterPageFile="~/Common.Master" AutoEventWireup="true" CodeBehind="ContactUs-ThankYou.aspx.cs" Inherits="ASPHTML5.Web.ContactUs_ThankYou" %>
...
<div class="font14px"><div style="text-transform: uppercase;"><asp:Literal ID="Literal9" runat="server" Text="<%$Resources:Text.FormTitle%>" /></div>
</div>
<script>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="cpMain">
    <div class="contact_form_padd">
      ...
      <div><img src="/images/spacer.gif" alt="" width="1" height="23" /></div>
