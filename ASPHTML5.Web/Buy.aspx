<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Buy.aspx.cs" Inherits="ASPHTML5.Web.Buy" MasterPageFile="~/Common.Master" Title="Buy real estate in Lebanon | Apartments for sale | ASPHTML5"  culture="auto" meta:resourcekey="PageResource1" uiculture="auto"%>
...
<script>id = "buy"</script>
<script>id2 = ""</script>
<div class="font14px"><asp:Literal ID="Literal4" runat="server" Text="<%$Resources:Text.PropertiesForSale%>" /></div>
